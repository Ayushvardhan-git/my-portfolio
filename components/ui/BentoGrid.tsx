...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("college202122dd@gmail.com");
    setCopied(true);
  };
  return (
    <div
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 2 && <GlobeDemo />}
          {id === 3 && (
            <div className=" flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-light-2">
              ...
              <div className="flex flex-col gap-3 lg:gap-8">
                ...
                {["PostgreSQL", "Docker", "AWS"].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
